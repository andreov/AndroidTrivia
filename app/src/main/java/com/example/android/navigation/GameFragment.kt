...
class GameFragment : Fragment() {
    ...
    // Первый ответ является правильным. Мы рандомизируем ответы, прежде чем показывать текст.
...
//                            .navigate(R.id.action_gameFragment_to_gameWonFragment)
                        ...
                        // Using directions to navigate to the GameWonFragment and add arguments
                            //передает количество вопросов и количество корректных ответов с помощью Bundle
                        view.findNavController()
